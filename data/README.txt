...
3) Drop songs from decades before 1950 
3) Drop the id feature since it contains no useful information
4) Remove any data entries that contain less than five total chords in the chords variable
...
unique_ngram_density for n=2,3,4,5: total number of unique length-n sequences divided by total number of chords
unique_2gram_difference: unique_2gram_density-unique_chord_density
